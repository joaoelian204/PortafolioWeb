  ...
  template: `
    <aside class="activity-bar">
      ...
      <div class="activity-icons-top">
        ...
        <button
          class="activity-icon"
          [class.active]="editorState.activityBarSection() === 'extensions'"
          (click)="editorState.setActivitySection('extensions')"
          title="Extensions (Ctrl+Shift+X)"
        >
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path d="M13.5 1.5L15 0h7.5L24 1.5V9l-1.5 1.5H15L13.5 9V1.5zm1.5 0V9h7.5V1.5H15zM0 15l1.5-1.5H9L10.5 15v7.5L9 24H1.5L0 22.5V15zm1.5 0v7.5H9V15H1.5zm0-13.5L0 3v7.5L1.5 12H9l1.5-1.5V3L9 1.5H1.5zm0 1.5H9v7.5H1.5V3zm13.5 10.5L13.5 15v7.5l1.5 1.5h7.5l1.5-1.5V15l-1.5-1.5H15zm0 1.5h7.5v7.5H15V15z"/>
          </svg>
        </button>
      </div>
      ...
      <div class="activity-icons-bottom">
        ...
        >
          <span style="font-size: 18px; font-weight: bold;">{{ i18n.language() === 'es' ? 'EN' : 'ES' }}</span>
        </button>
