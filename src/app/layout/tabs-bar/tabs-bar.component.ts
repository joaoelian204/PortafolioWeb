      ...
      <div class="tabs-container">
        @for (tab of editorState.tabs(); track tab.id) {
          <div
            ...
            (click)="editorState.setActiveTab(tab.id)"
          >
            <span class="tab-icon">
              @switch (tab.extension) {
                ...
                @case ('yaml') {
                  <svg viewBox="0 0 24 24" fill="#cb171e">
                    <path d="M.15 7.57L4.07 12l-3.92 4.43h1.62l3.1-3.5 3.1 3.5h1.62L5.67 12l3.92-4.43H8.04l-3.1 3.5-3.1-3.5H.15z"/>
                  </svg>
                }
                @default {
                  <svg viewBox="0 0 16 16" fill="#858585">
                    <path d="M13.85 4.44l-3.28-3.3-.35-.14H2.5l-.5.5v13l.5.5h11l.5-.5V4.8l-.15-.36zM10 2.52l2.99 2.99H10V2.52zM3 14V2h6v4h4v8H3z"/>
                  </svg>
                }
              }
            </span>
